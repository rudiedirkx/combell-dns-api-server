...
use rdx\combelldns\Client;
use rdx\combelldns\DnsRecord;
...
function client() {
	$client = new Client(new WebAuth($_SERVER['HTTP_X_COMBELL_BASE'], $_SERVER['PHP_AUTH_USER'], $_SERVER['PHP_AUTH_PW']));
	if ( !$client->logIn() ) {
